export const projects: Project[] = [
        ...
        },
        {
          ...
          image: '/images/airomap.jpg',
          previewVideo: '/videos/airomap.mp4',
          technologies: ['React Native', 'Express', 'MongoDB', 'Google SDKs'],
          progress: 100,
          type: 'mobile',
          category: ['mobile'],
          githubUrl: 'https://github.com/zaidahmad/AiroMap',
          liveUrl: 'https://airomap.example.com',
          highlights: [
        ...
        },
        {
          ...
          image: '/images/flexeere_ledger.jpg',
          previewVideo: '/videos/flexeere_ledger.mp4',
          technologies: ['Next.js', 'Prisma', 'MongoDB', 'Node.js'],
          progress: 90,
          type: 'fullstack',
          category: ['web'],
          githubUrl: 'https://github.com/zaidahmad/FlexeereLedger',
          liveUrl: 'https://flexeereledger.example.com',
          highlights: [
        ...
        },
        {
          ...
          type: 'fullstack',
          category: ['mobile','web'],
          githubUrl: 'https://github.com/zaidahmad/SchoolManagement',
          liveUrl: 'https://schoolmanagement.example.com',
          highlights: [
        ...
        },
        {
          ...
          image: '/images/telecaller_management.jpg',
